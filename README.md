...
```bash
pip install hledger_plot
```

Then run:

```sh
clear && hledger_plot --start-path ~/hledger-flow-example \
--account-holder your_name \
--bank triodos \
--account-type checking
--journal-path <the path to the journal you want to process>
```
